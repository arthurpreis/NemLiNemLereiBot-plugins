...
class Plugin():
    ...
    def register_plugin(self, PluginManager):
        PluginManager.register_plugin('cartacapital_com_br', r"^https?://cartacapital.com.br/"
                    "(sociedade|revista|internacional|cultura)/")
    ...
    def _get_content(self):
        paragraphs_list = []
        paragraphs = self.bs.select('.content > p') #TODO: descobrir como estrair o conteudo
...
def test():
    url = 'https://www.cartacapital.com.br/sociedade/precarizacao-pagina-no-facebook-expoe-vagas-de-emprego-arrombadas'
    pl = Plugin()
