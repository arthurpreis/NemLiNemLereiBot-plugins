...
class Plugin():
    ...
    def register_plugin(self, PluginManager):
        PluginManager.register_plugin('correiobraziliense_com_br', r"^https?://correiobraziliense.com.br/app/noticia/"
                            "(cidades|politica-brasil-economia|economia|mundo|esportes|entretenimento)")
    ...
    def _get_subtitle(self):
        subtitle = self.bs.select_one('h1.news-tit')
    ...
    def _get_published_date(self):
        ...
        state = str(self.bs.select('.details'))
    ...
    def _get_content(self):
        paragraphs_list = []
        paragraphs = self.bs.select('.js-body-news')
...
def test():
    url = 'http://www.correiobraziliense.com.br/app/noticia/cidades/2017/10/14/interna_cidadesdf,633544/cortes-no-orcamento-das-universidades-colocam-pesquisas-da-unb-em-risc.shtml'
    pl = Plugin()
